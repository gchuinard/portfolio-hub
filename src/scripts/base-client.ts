...
const translations: Record<string, Record<string, string>> = {
  fr: {
    ...
    "projects.released.entries": "en ligne",
    "projects.upcoming.entries": "en préparation",
    "projects.upcoming.label": "// en préparation",
    "projects.upcoming.intro": "# projets non livrés, exploration, prototype, ou backlog.\n# les descriptions et stacks peuvent encore bouger.",
    ...
    "projects.filter.empty": "aucun projet ne correspond à ce filtre",
  ...
  en: {
    ...
    "projects.released.entries": "live",
    "projects.upcoming.entries": "in progress",
    "projects.upcoming.label": "// in progress",
    "projects.upcoming.intro": "# unshipped projects, exploration, prototypes, or backlog.\n# descriptions and stacks may still change.",
    "projects.filter.hint": ", use filters to refine",
    "projects.filter.label": "filter_mode:",
    "projects.filter.and": "AND",
    "projects.filter.or": "OR",
    "projects.filter.empty": "no project matches this filter",
